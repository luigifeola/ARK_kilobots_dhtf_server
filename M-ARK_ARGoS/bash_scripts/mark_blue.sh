...
# ./src/examples/experiments/bash_run/mark_blue.sh /src/examples/experiments/bash_run dhtfs_experiment.argos dhtfc_experiment.argos
...
res_dir=$wdir/"results_dhtf/mark_blue"
if [[ ! -e $res_dir ]]; then
...
param_dir=$res_dir/"markBlue_"$date_time"_redAreas#"$hard_tasks"_"$experiment_length"seconds"
